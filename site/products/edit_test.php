...
<div class="container">
  <form id="productform" name="productform" action="process.php" method="post" enctype="multipart/form-data">
    ...
    <div class="section-panel">
      <div class="form-row">
        <div class="col">
          ...
          <select class="form-control" name="producttype">
            ...
            <option value="<?php echo $product_type ?>"
              <?php if ($form_data["pro_producttype"] == $product_type) print "selected" ?>><?php echo $product_type ?>
            </option>
            <?php 
            }
            ?>
        ...
        <div class="col">
          ...
          <input type="text" class="form-control" required name="productname" id="productname"
            placeholder="Product Name" value="<?php echo $form_data["pro_productname"] ?>">
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="col">
          ...
          <input type="text" class="form-control" name="alibabaurl" name="alibabaurl" id="alibabaurl"
            placeholder="Alibaba URL" value="<?php echo $form_data["pro_alibabaurl"] ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="col">
          <label for="retailurl">Retail URL</label>
          <input type="text" class="form-control" name="retailurl" name="retailurl" id="retailurl"
            placeholder="Retail URL" value="<?php echo $form_data["pro_retailurl"] ?>">
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="col">
          ...
          <input type="text" class="form-control" name="modelno" id="address" placeholder="Model No"
            value="<?php echo $form_data["pro_modelno"] ?>">
        </div>
        ...
        <div class="col">
          ...
          <select class="form-control" name="companyid" required>
            ...
            for ($i = 0; $i < count($company->result()); $i++) {
              ...
              ?>
            <option value="<?php echo $field_value["com_id"] ?>"
              <?php $form_data["pro_companyid"] == $field_value["com_id"] ? print "selected" : print ""; ?>>
              <?php echo $field_value["com_companyname"] ?></option>
            <?php 
          }
          ?>
          </select>
    ...
    <div class="section-panel">
      ...
      <div class="form-row">
        <div class="col">
          ...
          <input type="text" class="form-control" name="moq" id="moq" placeholder="Quantity"
            value="<?php echo $form_data["pro_moq"] ?>">
        </div>

        <div class="col">
          <label for="orderqty">Order Qty</label>
          <input type="text" class="form-control" name="orderqty" id="orderqty" placeholder="Actual Order Qty"
            value="<?php echo (int)$form_data["pro_orderqty"] ?>">
        </div>

        <div class="col">
          <label for=" ">Quoted Price Unit</label>
          <input type="text" class="form-control" name="quotedpriceunit" id="quotedpriceunit"
            placeholder="Quoted Price Unit" value="<?php echo $form_data["pro_quotedpriceunit"] ?>">
        </div>

        <div class="col">
          <label for="quotedpricetotal">Quoted Price Total</label>
          <input type="text" class="form-control" name="quotedpricetotal" id="quotedpricetotal"
            placeholder="Quoted Price Total" value="<?php echo $form_data["pro_quotedpricetotal"] ?>">
        </div>

        <div class="col">
          <label for="retailpercent">USD Rate</label>
          <input type="text" class="form-control" name="usdrate" id="usdrate" placeholder="USD Rate"
            value="<?php echo $form_data["pro_usdrate"] ?>">
        </div>

        <div class="col">
          <label for="roughlandedcost">Rough Landed Cost</label>
          <input type="text" class="form-control" name="roughlandedcost" id="roughlandedcost"
            placeholder="Rough Landed Cost" value="<?php echo $form_data["pro_roughlandedcost"] ?>">
        </div>
      </div>
    </div>
    ...
    <div class="section-panel">
      <div class="form-row">
        <div class="col">
          ...
          <input type="text" class="form-control" name="retailpriceunit" id="retailpriceunit"
            placeholder="Retail Price Unit" value="<?php echo (int)$form_data["pro_retailpriceunit"] ?>">
        </div>

        <div class="col">
          <label for="retailprice">Retail Price Total</label>
          <input type="text" class="form-control" name="retailpricetotal" id="retailpricetotal"
            placeholder="Retail Price Total" value="<?php echo (int)$form_data["pro_retailpricetotal"] ?>">
        </div>

        <div class="col">
          <label for="margin">Estimated Margin</label>
          <input type="text" class="form-control" name="margin" id="margin" placeholder="Margin"
            value="<?php echo (int)$form_data["pro_margin"] ?>">
        </div>

        <div class="col">
          <label for="retailpercent">Retail Percent</label>
          <input type="text" class="form-control" name="retailpercent" id="retailpercent" placeholder="Retail Percent"
            value="<?php echo $form_data["pro_retailpercent"] ?>">
        </div>

        <div class="col">
          <label for="approxsellprice">Approx Sell Price</label>
          <input type="text" class="form-control" name="approxsellprice" id="approxsellprice"
            placeholder="Approx Sell Price" value="<?php echo $form_data["pro_approxsellprice"] ?>">
        </div>

        <div class="col">
          <label for="retailprofit">Retail Profit</label>
          <input type="text" class="form-control" name="retailprofit" id="retailprofit" placeholder="Retail Profit"
            value="<?php echo $form_data["pro_retailprofit"] ?>">
        </div>

        <div class="col">
          <label for="estprofit">Estimated Profit</label>
          <input type="text" class="form-control" name="estprofit" id="estprofit" placeholder="Est Profit"
            value="<?php echo $form_data["pro_estprofit"] ?>">
        </div>
      </div>
    </div>
    ...
    <div class="section-panel">
      <div class="form-row">
        <h4 class="form-header">Shipping <span class="note-text">Note: Est Units 20ft and Est Units 40ft are a guide
            ONLY.</span></h4>
      </div>
      <div class="form-row">
        <div class="col">
          <label for="width">Width</label>
          <input type="text" class="form-control" name="width" name="width" id="width" placeholder="Width"
            value="<?php echo $form_data["pro_width"] ?>">
        </div>
        <div class="col">
          <label for="depth">Depth</label>
          <input type="text" class="form-control" name="depth" name="depth" id="depth" placeholder="Depth"
            value="<?php echo $form_data["pro_depth"] ?>">
        </div>
        <div class="col">
          <label for="height">Height</label>
          <input type="text" class="form-control" onblur="calc_cmb_unit()" name="height" name="height" id="height"
            placeholder="Height" value="<?php echo $form_data["pro_height"] ?>">
        </div>
        <div class="col">
          <label for="cmunit">CM (per unit)</label>
          <input type="text" class="form-control" name="cmunit" name="cmunit" id="cmunit" placeholder="CM (Per Unit)"
            value="<?php echo $form_data["pro_cmunit"] ?>">
        </div>
        <div class="col">
          <label for="units20">Est Units 20ft</label>
          <input type="text" class="form-control" name="units20" name="units20" id="units20"
            placeholder="Est Units 20ft" value="<?php echo $form_data["pro_units20"] ?>">
        </div>
        <div class="col">
          <label for="units40">Est Units 40ft</label>
          <input type="text" class="form-control" name="units40" name="units40" id="units40"
            placeholder="Est Units 40ft" value="<?php echo $form_data["pro_units40"] ?>">
        </div>
      </div>
      <div class="form-row">
        <div class="col">
          ...
          <select class="form-control" name="shcompanyid">
            ...
            for ($i = 0; $i < count($company->result()); $i++) {
              $field_value = $company->result()[$i];
              ?>
            <option value="<?php echo $field_value["shc_id"] ?>"
              <?php $form_data["pro_shcompanyid"] == $field_value["shc_id"] ? print "selected" : print ""; ?>>
              <?php echo $field_value["shc_shcompanyname"] ?></option>
            <?php 
          }
          ?>
          </select>
        ...
        <div class="col">
          ...
          <select class="form-control" name="shippingterms" required>
            ...
            <option value="FOB" <?php $form_data["pro_shippingterms"] == "FOB" ? print "selected" : print ""; ?>>FOB
            </option>
          </select>
        </div>
        <div class="col">
          ...
          <select class="form-control" name="freighttype" required>
            <option> -- select -- </option>
            <option value="LCL" <?php $form_data["pro_freighttype"] == "LCL" ? print "selected" : print ""; ?>>LCL
            </option>
            <option value="20'GP" <?php $form_data["pro_freighttype"] == "20'GP" ? print "selected" : print ""; ?>>20'GP
            </option>
            <option value="40'GP" <?php $form_data["pro_freighttype"] == "40'GP" ? print "selected" : print ""; ?>>40'GP
            </option>
            <option value="Airfreight"
              <?php $form_data["pro_freighttype"] == "Airfreight" ? print "selected" : print ""; ?>>Airfreight</option>
          </select>
        </div>
      </div>
      <div class="form-row">
        <div class="col">
          ...
          <input type="text" class="form-control" onblur="calc_weight_total()" name="weightunit" name="weightunit"
            id="weightunit" placeholder="Weight Per Unit" value="<?php echo $form_data["pro_weightunit"] ?>">
        </div>

        <div class="col">
          <label for="weighttotal">Weight Total</label>
          <input type="text" class="form-control" name="weighttotal" name="weighttotal" id="weighttotal"
            placeholder="Weight Total" value="<?php echo $form_data["pro_weighttotal"] ?>">
        </div>
      </div>
    </div>
...
pfc.addEventListenerAndSetTargetValue('focus', 'quotedpricetotal', calc);
...
// let inputElms = document.getElementsByTagName("[input = 'text");
